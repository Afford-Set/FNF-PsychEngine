...
class StrumNote extends FlxSprite
{
	...
	public function new(x:Float, y:Float, leData:Int, player:Int):Void
	{
		...
		if (player == 1 && PlayState.SONG != null && PlayState.SONG.arrowSkin != null && PlayState.SONG.arrowSkin.length > 1) {
			skin = PlayState.SONG.arrowSkin;
		}
		else if (player == 2 && PlayState.SONG != null && PlayState.SONG.arrowSkin2 != null && PlayState.SONG.arrowSkin2.length > 1) {
