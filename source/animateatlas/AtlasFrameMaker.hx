...
class AtlasFrameMaker extends FlxFramesCollection
{
	...
	*/
	...
	public static function construct(graphic:FlxGraphic, rawJson:String, rawJson2:String, ?_excludeArray:Array<String> = null, ?noAntialiasing:Bool = false):FlxFramesCollection
	{
		var animationData:AnimationData = Json.parse(rawJson);
		var atlasData:AtlasData = Json.parse(rawJson2.replace('\uFEFF', ''));
		...
		var frameCollection:FlxFramesCollection = new FlxFramesCollection(graphic, FlxFrameCollectionType.IMAGE);
