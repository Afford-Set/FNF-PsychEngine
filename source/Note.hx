...
class Note extends FlxSprite
{
	...
	{
		noteSplashData.texture = (PlayState.SONG != null) ? (mustPress ?  PlayState.SONG.splashSkin : PlayState.SONG.splashSkin2) : 'noteSplashes';
		defaultRGB();
	...
	public function reloadNote(texture:String = '', postfix:String = ''):Void
	{
		...
		if (texture.length < 1)
		{
			skin = PlayState.SONG != null ? (mustPress ? PlayState.SONG.arrowSkin : PlayState.SONG.arrowSkin2) : null;
