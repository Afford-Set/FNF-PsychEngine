...
class FlxVirtualPad extends FlxSpriteGroup
{
	...
	public function new(DPad:FlxDPadMode, Action:FlxActionMode):Void
	{
		...
		#if MOBILE_CONTROLS
		var buttonLeftColor:Array<FlxColor> = ClientPrefs.defaultData.arrowRGB[0];
		var buttonDownColor:Array<FlxColor> = ClientPrefs.defaultData.arrowRGB[1];
		var buttonUpColor:Array<FlxColor> = ClientPrefs.defaultData.arrowRGB[2];
		var buttonRightColor:Array<FlxColor> = ClientPrefs.defaultData.arrowRGB[3]; 
		...
		{
			case UP_DOWN:
				add(buttonUp = createButton(0, FlxG.height - 255, 132, 127, 'up', buttonUpColor[0], UP));
				add(buttonDown = createButton(0, FlxG.height - 135, 132, 127, 'down', buttonDownColor[0], DOWN));
			case LEFT_RIGHT:
				add(buttonLeft = createButton(0, FlxG.height - 135, 132, 127, 'left', buttonLeftColor[0], LEFT));
				add(buttonRight = createButton(127, FlxG.height - 135, 132, 127, 'right', buttonRightColor[0], RIGHT));
			case UP_LEFT_RIGHT:
				add(buttonUp = createButton(105, FlxG.height - 243, 132, 127, 'up', buttonUpColor[0], UP));
				add(buttonLeft = createButton(0, FlxG.height - 135, 132, 127, 'left', buttonLeftColor[0], LEFT));
				add(buttonRight = createButton(207, FlxG.height - 135, 132, 127, 'right', buttonRightColor[0], RIGHT));
			case LEFT_FULL:
				add(buttonUp = createButton(105, FlxG.height - 345, 132, 127, 'up', buttonUpColor[0], UP));
				add(buttonLeft = createButton(0, FlxG.height - 243, 132, 127, 'left', buttonLeftColor[0], LEFT));
				add(buttonRight = createButton(207, FlxG.height - 243, 132, 127, 'right', buttonRightColor[0], RIGHT));
				add(buttonDown = createButton(105, FlxG.height - 135, 132, 127, 'down', buttonDownColor[0], DOWN));
			case RIGHT_FULL:
				add(buttonUp = createButton(FlxG.width - 258, FlxG.height - 408, 132, 127, 'up', buttonUpColor[0], UP));
				add(buttonLeft = createButton(FlxG.width - 384, FlxG.height - 309, 132, 127, 'left', buttonLeftColor[0], LEFT));
				add(buttonRight = createButton(FlxG.width - 132, FlxG.height - 309, 132, 127, 'right', buttonRightColor[0], RIGHT));
				add(buttonDown = createButton(FlxG.width - 258, FlxG.height - 201, 132, 127, 'down', buttonDownColor[0], DOWN));
			case BOTH_FULL:
				add(buttonUp = createButton(105, FlxG.height - 345, 132, 127, 'up', buttonUpColor[0], UP));
				add(buttonLeft = createButton(0, FlxG.height - 243, 132, 127, 'left', buttonLeftColor[0], LEFT));
				add(buttonRight = createButton(207, FlxG.height - 243, 132, 127, 'right', buttonRightColor[0], RIGHT));
				add(buttonDown = createButton(105, FlxG.height - 135, 132, 127, 'down', buttonDownColor[0], DOWN));
				add(buttonUp2 = createButton(FlxG.width - 258, FlxG.height - 408, 132, 127, 'up', buttonUpColor[0], UP2));
				add(buttonLeft2 = createButton(FlxG.width - 384, FlxG.height - 309, 132, 127, 'left', buttonLeftColor[0], LEFT2));
				add(buttonRight2 = createButton(FlxG.width - 132, FlxG.height - 309, 132, 127, 'right', buttonRightColor[0], RIGHT2));
				add(buttonDown2 = createButton(FlxG.width - 258, FlxG.height - 201, 132, 127, 'down', buttonDownColor[0], DOWN2));
			case DIALOGUE_PORTRAIT_EDITOR:
				add(buttonUp = createButton(105, FlxG.height - 345, 132, 127, 'up', buttonUpColor[0], UP));
				add(buttonLeft = createButton(0, FlxG.height - 243, 132, 127, 'left', buttonLeftColor[0], LEFT));
				add(buttonRight = createButton(207, FlxG.height - 243, 132, 127, 'right', buttonRightColor[0], RIGHT));
				add(buttonDown = createButton(105, FlxG.height - 135, 132, 127, 'down', buttonDownColor[0], DOWN));
				add(buttonUp2 = createButton(105, 0, 132, 127, 'up', buttonUpColor[0], UP2));
				add(buttonLeft2 = createButton(0, 82, 132, 127, 'left', buttonLeftColor[0], LEFT2));
				add(buttonRight2 = createButton(207, 82, 132, 127, 'right', buttonRightColor[0], RIGHT2));
				add(buttonDown2 = createButton(105, 190, 132, 127, 'down', buttonDownColor[0], DOWN2));
			case MENU_CHARACTER:
				add(buttonUp = createButton(105, 0, 132, 127, 'up', buttonUpColor[0], UP));
				add(buttonLeft = createButton(0, 82, 132, 127, 'left', buttonLeftColor[0], LEFT));
				add(buttonRight = createButton(207, 82, 132, 127, 'right', buttonRightColor[0], RIGHT));
				add(buttonDown = createButton(105, 190, 132, 127, 'down', buttonDownColor[0], DOWN));
			case NOTE_SPLASH_DEBUG:
				add(buttonLeft = createButton(0, 0, 132, 127, 'left', buttonLeftColor[0], LEFT));
				add(buttonRight = createButton(127, 0, 132, 127, 'right', buttonRightColor[0], RIGHT));
				add(buttonUp = createButton(0, 125, 132, 127, 'up', buttonUpColor[0], UP));
				add(buttonDown = createButton(127, 125, 132, 127, 'down', buttonDownColor[0], DOWN));
				add(buttonUp2 = createButton(127, 393, 132, 127, 'up', buttonUpColor[0], UP2));
				add(buttonLeft2 = createButton(0, 393, 132, 127, 'left', buttonLeftColor[0], LEFT2));
				add(buttonRight2 = createButton(1145, 393, 132, 127, 'right', buttonRightColor[0], RIGHT2));
				add(buttonDown2 = createButton(1015, 393, 132, 127, 'down', buttonDownColor[0], DOWN2));
	...
	private function createButton(X:Float, Y:Float, Width:Int, Height:Int, Graphic:String, ?Color:Int = 0xFFFFFF, ?id:FlxMobileControlsID = NONE):FlxButton
	{
	...
	public function mobileControlsPressed(buttonID:FlxMobileControlsID):Bool
	{
		switch (buttonID)
		{
			...
			case FlxMobileControlsID.NONE:
				return false;
			case FlxMobileControlsID.ANY:
			{
				var array:Array<FlxButton> = [
					buttonLeft,
					buttonDown, buttonUp, buttonRight, buttonLeft2, buttonDown2,
					buttonUp2, buttonRight2, buttonA, buttonB, buttonC, buttonD,
					buttonE,
					buttonV,
	...
	public function firstJustPressed():FlxMobileControlsID
	{
		var array:Array<FlxButton> = [
			buttonLeft,
			buttonDown, buttonUp, buttonRight, buttonLeft2, buttonDown2,
	...
	public function firstPressed():FlxMobileControlsID
	{
		var array:Array<FlxButton> = [
			buttonLeft,
			buttonDown, buttonUp, buttonRight, buttonLeft2, buttonDown2,
	...
	public function firstJustReleased():FlxMobileControlsID
	{
		var array:Array<FlxButton> = [
			buttonLeft,
			buttonDown, buttonUp, buttonRight, buttonLeft2, buttonDown2,
	...
	public function anyJustPressed(keys:Array<FlxMobileControlsID>):Bool
	{
		for (key in keys)
		{
			if (key != NONE && mobileControlsJustPressed(key)) {
				return true;
			}
		}
	...
	public function anyPressed(keys:Array<FlxMobileControlsID>):Bool
	{
		for (key in keys)
		{
			if (key != NONE && mobileControlsPressed(key)) {
				return true;
			}
		}
	...
	public function anyJustReleased(keys:Array<FlxMobileControlsID>):Bool
	{
		for (key in keys)
		{
			if (key != NONE && mobileControlsJustReleased(key)) {
				return true;
			}
		}
