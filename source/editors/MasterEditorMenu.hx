...
class MasterEditorMenu extends MusicBeatState
{
	...
	function goToState(label:String):Void
	{
		switch (label)
		{
			...
			#end
			case 'Note Splash Debug': return LoadingState.loadAndSwitchState(new NoteSplashDebugState(), true);
			case 'Character Editor': return LoadingState.loadAndSwitchState(new CharacterEditorState(Character.DEFAULT_CHARACTER, false), true);
